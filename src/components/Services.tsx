      ...
      <section className='resume-section' id='services'>
        <div className='resume-section-content'>
          ...
          <p>
            ...
            the users on a robust, scalable, secure and reliable platform.
          </p>
          <div className='d-flex flex-column flex-md-row justify-content-between mb-2'>
            <div className='flex-grow-1'>
              ...
              <ul>
                <li>
                  Compare LLMs and GenAI tools to identify the right one for the
                  task at hand
                </li>
                <li>
                  Identify real-world use cases of AI solving commercial
                  problems that align to your business needs
                </li>
                <li>
                  Confidently choose the right LLM(s) and GenAI tools for your
                  business, backed by metrics
                </li>
                <li>
          ...
          <div className='d-flex flex-column flex-md-row justify-content-between mb-2'>
            <div className='flex-grow-1'>
              ...
              <ul>
                <li>
                  Implement a customer support AI chatbot trained on your
                  product line and support policies integrated with your mobile
                  app and website
                </li>
                <li>
                ...
                <li>
                  ...
                  leads, drive traffic, and generate content (blog posts,
                  YouTube scripts, social media posts, emails, images, audio,
                  etc.)
                </li>
                <li>
                ...
                <li>
                  Implement reliable data pipelines to continuously feed your
                  AIs and data analytics platform with quality data
                </li>
                <li>
          ...
          <div className='d-flex flex-column flex-md-row justify-content-between mb-2'>
            <div className='flex-grow-1'>
              ...
              <p>
                ...
                technology and processes. Assist with training technical teams
                and hiring specialists to build and support the new
                infrastructure.
              </p>
              <ul>
                ...
                <li>
                  Design a scalable and modular system that will grow with your
                  business
                </li>
                <li>
                ...
                <li>
                  Use core MLOps principles to automate and streamline the
                  entire ML lifecycle to achieve greater efficiency,
